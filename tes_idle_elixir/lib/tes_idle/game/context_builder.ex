defmodule TesIdle.Game.ContextBuilder do
  ...
  @location_profiles %{
    "city" => %{"exploring" => 15, "fighting" => 10, "looting" => 5, "resting" => 20, "shopping" => 20, "socializing" => 20, "traveling" => 10},
    "village" => %{"exploring" => 20, "fighting" => 10, "looting" => 5, "resting" => 20, "shopping" => 15, "socializing" => 15, "traveling" => 15},
    "dungeon" => %{"exploring" => 25, "fighting" => 45, "looting" => 20, "resting" => 5, "shopping" => 0, "socializing" => 0, "traveling" => 5},
    "wilderness" => %{"exploring" => 35, "fighting" => 30, "looting" => 15, "resting" => 10, "shopping" => 0, "socializing" => 0, "traveling" => 10},
  }
  ...
  def build(hero_id) do
    ...
    {hunger, fatigue, morale} = apply_weather(location, weather, hero.hunger, hero.fatigue, hero.morale)
  ...
  def load_configs do
    ...
    defaults = %{
      ...
      "needs" => %{"hunger_high" => 70, "fatigue_high" => 70, "morale_low" => 30, "hp_low_ratio" => 0.3},
      ...
      "needs_delta" => %{"hunger_increase" => [0.5, 2.0], "fatigue_increase" => [0.3, 1.0], "morale_drift" => [-0.5, 0.5]},
      "mood" => %{"base" => 50, "hunger_weight" => 0.2, "fatigue_weight" => 0.15, "morale_weight" => 0.15},
      "combat" => %{"level_range" => 2, "damage_variance" => [-3, 5]},
      "leveling" => %{"xp_multiplier" => 1.5, "hp_per_level" => 10, "attack_base" => 2, "attack_decay" => 0.01, "defense_base" => 1, "defense_decay" => 0.01},
      ...
      "socializing" => %{"morale_gain" => [3, 8], "gamble_chance" => 0.15, "gamble_gold_range" => [5, 30]},
