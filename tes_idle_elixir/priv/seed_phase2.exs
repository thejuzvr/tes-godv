...
#
# A-1: item.tags (fish/herb/component/ore/lockpick)
# A-6: narrative_templates для fishing/gather/mining/steal/break_in/jail/pet_care
#      + переменные {fish_name}, {herb_name}, {ore_name}, {pet_name}, {witness_name}, {fine_gold}
...
items = [
  %{
    ...
    tags: ["fish", "food"],
    price: 4,
    description: "Свежая, ещё пахнет рекой."
  },
  %{
    name: "Ловкая форель",
    item_type: "consumable",
    ...
    tags: ["fish", "food"],
    price: 7,
    description: "Бьётся в руках так, что мало не покажется."
  },
  %{
    ...
    tags: ["fish", "food"],
    price: 5,
    description: "Чешуя переливается на солнце."
  },
  %{
    name: "Пучок лаванды",
    item_type: "material",
    ...
    tags: ["herb", "component"],
    price: 3,
    description: "Пахнет покоем и тихими вечерами."
  },
  %{
    name: "Можжевеловые ягоды",
    item_type: "material",
    icon: "🫐",
    tags: ["herb", "component"],
    price: 3,
    description: "Горсть синих ягод, хороши в настой."
  },
  %{
    name: "Светящийся мох",
    item_type: "material",
    ...
    tags: ["herb", "component"],
    price: 12,
    description: "Слабо светится в темноте подземелий."
  },
  %{
    ...
    tags: ["herb", "component"],
    price: 15,
    description: "Редкий корень, целители отрывают с руками."
  },
  %{
    name: "Железная руда",
    item_type: "material",
    ...
    tags: ["ore"],
    price: 8,
    description: "Тяжёлый кусок руды для кузницы."
  },
  %{
    name: "Лунный камень",
    item_type: "material",
    ...
    tags: ["ore"],
    price: 15,
    description: "Бледная жила, мерцающая в темноте."
  },
  %{
    name: "Отмычка",
    item_type: "tool",
    ...
    tags: ["lockpick"],
    price: 10,
    description: "Тонкая, гибкая, надёжная. Пока не сломается."
  }
]
...
mining_start = [
  "{hero_name} выбрал рудную жилу и взялся за кирку.",
  "В шахте стало слышно, как {hero_name} готовит первый удар по камню."
]

mining_wait = [
  "Кирка звенит о жилу; {hero_name} не спешит сдаваться.",
  "Камень упрямится, а {hero_name} продолжает работу."
]

mining_found = [
  "{hero_name} ударил киркой по жиле и добыл {ore_name}.",
  "Камень сопротивлялся, но {ore_name} всё же оказался в сумке {hero_name}.",
  "В шахте звенело эхо: {hero_name} нашёл {ore_name}.",
  "Пыль на лице, {ore_name} в ладони — работа {hero_name} не пропала зря.",
  "{ore_name} блеснул в трещине, когда {hero_name} уже почти хотел бросить кирку."
]
...
Enum.each(mining_start, &Phase2Seed.ensure_template("mining_start", &1))
Enum.each(mining_wait, &Phase2Seed.ensure_template("mining_wait", &1))
Enum.each(mining_found, &Phase2Seed.ensure_template("mining_found", &1))
